      ...
      if(bUUID == "df5a60394a2e-f41b-fafc-6cbe-70468752")
      {
        ...
        if((bRSSI >= -55) && (bMajor < 30) && (beacon_device_in_this_time[bMajor] <= 7)){ 
         ...
         if(beacon_device[bMajor] == 7 && beacon_rssi_close_device[bMajor] > -90){
            ...
            reconnect();
            Firebase.setInt(firebaseData, "/esp32 no_3/" + String(bMajor) + "/RSSI", beacon_rssi_close_device[bMajor]);
            ...
            reconnect();
            Firebase.setInt(firebaseData, "/esp32 no_3/" + String(bMajor) + "/Major", bMajor);
            Firebase.setInt(firebaseData, "/esp32 no_3/" + String(bMajor) + "/Minor", bMinor);
            Firebase.setInt(firebaseData, "/esp32 no_3/" + String(bMajor) + "/time", second);
            Firebase.setInt(firebaseData, "/esp32 no_3/" + String(bMajor) + "/epochTime_temp", epochTime_temp);
            delay(400);      
            ...
            reconnect();
            Firebase.setInt(firebaseData, "/esp32 no_3/" + String(bMajor) + "/RSSI", div_RSSI);
...
void loop()
{
  ...
  if(epochTime_count == 0){
    ...
    Firebase.setInt(firebaseData, "/esp32 no_3/time/time" , epochTime);
    epochTime_count++;
    delay(1000);
  }
