...
{   
    void onResult(BLEAdvertisedDevice advertisedDevice)
    {
      ...
      time_t now; 
      time(&now);
      Firebase.setInt(firebaseData, "/time", now);
      delay(500);
      ...
      Firebase.setInt(firebaseData, "/esp32 no_0/" + bUUID + "/RSSI", beacon_rssi_close_device[ID_No]);
      ...
      Firebase.setInt(firebaseData, "/esp32 no_0/" + bUUID + "/RSSI", div_RSSI);
