...
class MyAdvertisedDeviceCallbacks: public BLEAdvertisedDeviceCallbacks
{
    void onResult(BLEAdvertisedDevice advertisedDevice)
    {
      ...
      Serial.print(bRSSI);
      Firebase.setInt(firebaseData, "/RSSI", bRSSI);    //Send a integer to the database(傳數字給firebase的即時數據庫)
      ...
      Serial.println(M);
      Firebase.setFloat(firebaseData, "/distance", M);    //Send a Float to the database(傳數字給firebase的即時數據庫)
      }
